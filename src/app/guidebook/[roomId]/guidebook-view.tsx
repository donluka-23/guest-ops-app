    ...
    <div className="mx-auto flex w-full max-w-lg flex-col gap-4 p-4">
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0">
          <h1 className="truncate text-lg font-semibold">{data.property_name}</h1>
          ...
          <CardContent className="flex flex-col gap-3">
            {data.wifi_ssid && (
              <div className="flex flex-col gap-1">
                ...
                <CopyableText value={data.wifi_ssid} copyLabel={t.copy} copiedLabel={t.copied} />
              </div>
            )}
            {data.wifi_password && (
              <div className="flex flex-col gap-1">
      ...
      {data.checkout_time && (
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t.checkoutTime}</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {groupedExtras.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t.localGuide}</CardTitle>
          </CardHeader>
